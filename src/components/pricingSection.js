    ...
    <Container>
      ...
      <div className="pricing-section__plan-box">
        ...
        <Card type="pricing">
          ...
          <p className="card--pricing__plan-price--info">/user/month</p>
          <p className="card--pricing__plan-feature">all the basic features</p>
          <p className="card--pricing__plan-feature">+</p>
          <p className="card--pricing__plan-feature">cool blockchain thingy</p>
          ...
          <p className="card--pricing__plan-feature">more spectacular things</p>
        </Card>
        <Card type="pricing">
          <p className="card--pricing__plan-name">
            Enterprise
          ...
          <p className="card--pricing__plan-feature">crazy good 24/7 support</p>
          <p className="card--pricing__plan-feature">top-notch cybersecurity</p>
          <p className="card--pricing__plan-feature">robots with sick moves</p>
        </Card>
      </div>
    </Container>
  </div>
